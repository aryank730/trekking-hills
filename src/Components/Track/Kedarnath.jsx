    ...
    <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 xl:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="mt-6 text-xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
            Start your Kedarnath in 4 easy steps
          </h2>
              ...
              <div className="mt-8">
                ...
                >
                  ...
                  <li className="flex items-start lg:col-span-1">
                    ...
                    <p className="ml-3 ">
                    Guaranteed on-time drop-off at the pickup point
                    </p>
                  </li>
                </ul>
              </div>
