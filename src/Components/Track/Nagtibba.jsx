          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
              ...
              <div className="py-8 px-6 text-center lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12 bg-gray-700">
                <p className="text-lg text-left leading-6 font-medium text-white">
                  

                  <label  for="cars">Pick up me from ...</label><br />

                  <select className='text-orange-500 outline-none ' id="cars">
                    <option className='text-black' value="volvo">Dehradun</option>
                    <option className='text-black' value="saab">Sankri village</option>
                  </select>
                </p>
