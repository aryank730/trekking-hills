...
<>
  {/* ABOUT Section */}
  <div className="w-full lg:h-screen h-full m-auto flex items-center justify-cetner py-12 bg-gray-50 dark:bg-gray-900">
    <div className="w-full h-full flex flex-col justify-center items-center sm:px-4 px-2">
      ...
      <div className="lg:w-[90%] w-full mx-auto flex flex-col lg:gap-6 lg:flex-row items-center justify-center ">
        ...
        {/*  */}
        <div className="lg:w-[60%] p-4 w-full h-full shadow-xl shadow-gray-300/40 flex flex-col justify-center items-center sm:px-6 px-4 rounded-xl">
          <h2 className="text-4xl text-center text-gray-600 dark:text-gray-400 font-bold px-4 py-1 md:mt-0 mt-10">
            About Us
          </h2>
  ...
  <div className="w-[28%] rounded max-w-2xl mx-auto overflow-hidden bg-white dark:bg-gray-800/50 backdrop-blur-lg">
    ...
    <div className="relative flex flex-col md:flex-row md:items-center gap-6">
      ...
      <div className="flex-shrink-0">
        <div className="relative group">
          <div className="absolute w-28 h-28 -inset-0.5 bg-gradient-to-r from-gray-900 to-gay-900 rounded-full blur opacity-40 group-hover:opacity-75 transition duration-200"></div>
          <img
